...
class Filofax_Upsells_Block_Adminhtml_Promo_Quote_Edit_Tab_Products_Category
    extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Categories
{
    ...
    {
        $url = $this->getUrl('adminhtml/filoupsell_category/categoriesJson', array('_current' => true));
