...
class Filofax_Upsells_Model_Banners extends Mage_Core_Model_Abstract
{
    const DISABLE = 0;
    const ENABLE = 1;
    ...
    public function getRulesCollection()
    {
        ...
        $rulesCollection->getSelect()->joinInner(
            ...
            array(
            'upsells' => $rulesCollection->getTable('filoupsell/upsells')),
            'main_table.rule_id = upsells.rule_id',
            '*'
        );
